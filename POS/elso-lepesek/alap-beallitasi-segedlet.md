# ⚙️ Alap beállítási segédlet

## Fontos tudnivalók a működésről

Mielőtt elkezdenénk új, modern, letisztult eladói felületed beállítani, előtte néhány fontos információt tudnod kell a BarSoft működésével kapcsolatban.

### Felhő alapú működés

Nálunk majdnem minden adat a felhőben tárolódik, ami azt jelenti (mint ahogy már korábban is említettük), hogy szükséges internet kapcsolat ahhoz, hogy megfelelően működjön a rendszer, viszont ha nem áll rendelkezésedre stabil internetkapcsolat, akkor vész üzemben elég naponta 1x felcsatlakoztatni a hálózatra, hogy felszinkronizálódjanak az adatok.

{% hint style="warning" %}
**FONTOS INFORMÁCIÓ**

Ahhoz, hogy minden szolgáltatásunk és integrációnk megfelelően működjön, extrém fontos a stabil internet kapcsolat, tehát a net nélküli működés az egyfajta _**vészüzem,**_ amire nem szabad támaszkodni a hétköznapokban.
{% endhint %}

### Műszak nyitás - Műszak zárás

Ahhoz, hogy el tudd kezdeni az értékesítést meg kell nyitod a műszakot.
...
Lássuk, hogy hogyan tudod személyre szabni új értékesítő felületed!
