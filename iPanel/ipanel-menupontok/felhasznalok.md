...
{% embed url="https://youtu.be/1vnLlqerquo" %}
...
* **Szerkesztés**:&#x20;
  ...
  * Lokációnkénti jogosultság beállítása
...
Létrehozás után a szerkesztéssel tudunk hozzáadni jogosultságot a felhasználóhoz, ezután már készen is áll a munkára.

### <mark style="color:green;">Felhasználó</mark> esetén

Itt két megoldást is felkínálunk:
...
{% tab title="Hozzárendelés" %}
<figure><img src="../.gitbook/assets/Képernyőkép 2024-11-27 130702 (1).png" alt=""><figcaption></figcaption></figure>

Ezzel a módszerrel a már beregisztrált felhasználót tudjuk hozzárendelni a brand-ünkhöz. Tehát előzetesen a felhasználónak regisztrálva kell lennie az iPanel felületen.
{% endtab %}
{% endtabs %}
